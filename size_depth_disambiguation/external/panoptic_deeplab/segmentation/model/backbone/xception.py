...
class XceptionBlock(nn.Module):
    def __init__(
        ...
        self.sep_conv1 = SeparableConv2d(
            channel_list[0],
            channel_list[1],
            dilation=dilation,
        ...
        self.sep_conv2 = SeparableConv2d(
            channel_list[1],
            channel_list[2],
            dilation=dilation,
            relu_first=relu_first,
        ...
        self.sep_conv3 = SeparableConv2d(
            channel_list[2],
            channel_list[3],
            dilation=dilation,
            relu_first=relu_first,
...
class Xception65(nn.Module):
    def __init__(self, replace_stride_with_dilation=None, norm_layer=None):
        ...
        self.block6 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block7 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block8 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block9 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block10 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block11 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block12 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block13 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block14 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block15 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block16 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block17 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block18 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
        )
        self.block19 = XceptionBlock(
            [728, 728, 728, 728],
            dilation=middle_block_dilation,
            skip_connection_type="sum",
            norm_layer=norm_layer,
...
def xception65(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(
            model_urls["xception65"], progress=progress
        )
