...
class DemoData(base):
    ...
    def estimate_trans_cliff(self, joints, keypoints, center, focal_length, img_h, img_w):
        ...
        gt_cam_t = estimate_translation_np(joints, keypoints[:, :2], keypoints[:, 2], focal_length=focal_length,
    ...
    def create_data(self, index=0):
        ...
        for batch_idx in range(batch_size):
            ...
            for i in range(len(boxes)):
                ...
                patch, crop_ul, crop_br, new_shape, new_x, new_y, old_x, old_y = self.rgb_processing(img.copy(), center,
                                                                                                     1 * scale, 0, 0,
                                                                                                     np.ones(3))
